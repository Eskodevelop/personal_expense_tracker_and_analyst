          ...
          <div className="stat-left">
            {chart === "pie" && (
              <Chart
                ...
                options={{ title: "Transactions For Last Year per Months" }}
                width={"500px"}
                height={"500px"}
              />
            )}
